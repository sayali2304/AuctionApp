import 'package:auction/screens/home_screen.dart';
import 'package:auction/screens/auction_page.dart';
      ...
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute(
            builder: (context) => AuctionPage(
                ...
                bidPrice:
                    bidPrice))); // AuctionPageModel will be introduced in next resources, for now leave it
      },
      child: Container(
